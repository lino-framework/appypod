...
class Date(Field):
     ...
     <x var="years=field.getSelectableYears()">
      ...
      <select var="days=range(1,32)" if="field.showDay"
       ...
       <option for="day in days"
         var2="zDay=str(day).zfill(2)" value=":zDay"
               selected=":field.isSelected(zobj, name, 'day', day, \
      ...
      <select var="months=range(1,13)"
       ...
       <option for="month in months"
               ...
               selected=":field.isSelected(zobj, name, 'month', month, \
      ...
      <x if="field.format == 0">
       <select var="hours=range(0,24)" name=":'%s_hour' % name"
        ...
        <option for="hour in hours"
                ...
                selected=":field.isSelected(zobj, name, 'hour', hour, \
       ...
       <select var="minutes=range(0,60,field.minutesPrecision)"
        ...
        <option for="minute in minutes"
                ...
                selected=":field.isSelected(zobj, name, 'minute', minute,\
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
      format=WITH_HOUR, dateFormat=None, hourFormat=None, calendar=True,
      startYear=time.localtime()[0]-10, endYear=time.localtime()[0]+10,
      reverseYears=False, minutesPrecision=5, show=True, page='main',
      ...
      mapping=None, label=None, sdefault=None, scolspan=1, swidth=None,
      sheight=None, persist=True, view=None, cell=None, xml=None, showDay=True):
        self.format = format
    ...
    def isSelected(self, obj, name, fieldPart, dateValue, dbValue):
