...
from appy.gen import Field, Layouts
...
class Calendar(Field):
    ...
    pxAddPopup = Px('''
     <div var="popupId=ajaxHookId + '_new';
      ...
      <form id=":popupId + 'Form'" method="post" action="/process">
       ...
       <div align="center"
            style="margin-bottom: 3px">:_(field.createEventLabel)</div>
    ...
    pxViewMonth = Px('''
      <table cellpadding="0" cellspacing="0" width=":field.width"
             class=":field.style" id=":ajaxHookId + '_cal'"
    ...
    def __init__(self, eventTypes=None, eventNameMethod=None,
      ...
      show=('view', 'xml'), page='main', group=None, layouts=None, move=0,
      specificReadPermission=False, specificWritePermission=False, width='100%',
      height=300, colspan=1, master=None, masterValue=None, focus=False,
      mapping=None, label=None, maxEventLength=50, render='month', others=None,
      timelineName=None, additionalInfo=None, startDate=None, endDate=None,
      defaultDate=None, timeslots=None, colors=None, showUncolored=False,
      ...
      legend=None, view=None, cell=None, xml=None, delete=True,
      selectableMonths=6, createEventLabel='which_event',
      style='list calTable'):
        ...
        Field.__init__(self, validator, (0,1), default, show, page, group,
          ...
          masterValue, focus, False, mapping, label, None, None, None, None,
    ...
    def getDefaultLayouts(self): return Layouts.Calendar.b
