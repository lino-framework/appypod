    ...
    def addRoles(self, roles, permissions=()):
        ...
        for perm, existingRoles in self.permissions.items():
            ...
            for role in roles:
                ...
                alreadyThere = False
                isName = isinstance(role, str)
                roleName = isName and role or role.name
                ...
                existingRoles.append(isName and self.getRole(role) or role)
...
class WorkflowOwner:
    ...
    def doDeactivate(self, obj):
        ...
        if (obj.__class__.__name__ == 'User') and (obj.login == 'admin'):
